        ...
        <div className={styles.container}>
            <div className={styles.dino} aria-hidden="true">
                ...
                >
                    ...
                    <path
                        d="M24 46 C24 32 32 22 44 22 C52 22 58 28 58 36 C58 44 56 48 52 50 L52 56 L44 56 L44 50 C38 50 32 48 28 52 Z"
                        fill="currentColor"
                        opacity="0.7"
                    />
                    ...
                    {}
                    <path
                        d="M44 22 L42 16 L46 20 L48 13 L50 20 L54 15 L54 22"
                        fill="currentColor"
                        opacity="0.5"
                    />
                </svg>
